          ...
          <div class="ui two column grid">
            <div class="column">
              <el-breadcrumb separator="/">
                  ...
                  <el-breadcrumb-item>用户博客</el-breadcrumb-item>
...
export default {
  ...
  methods: {
    getBlogListByUserId(current) {
      const _this = this;
      let params = this.$qs.stringify({
        'userId':this.$route.params.userId,
        'current':current
      })
      blogApi.getBlogListByUserId(params).then((req) => {
    ...
    lastPage() {
      ...
      this.current--;
      this.getBlogListByUserId(this.current)
    },
    nextPage() {
      let current = document.querySelector("#current").innerHTML;
